...
// To_Address
    ...
    System.out.println(id1);
        ...
        // CN_Creation
    @Test (priority = 2)
    public void cnCreate() throws IOException {
        ...
        JsonPath cn = new JsonPath(res_CnCreation);
        String Cnote1 = cn.getString("payload.cnote");
      Assert.assertEquals(Cnote1, Cnote);
